      ...
      >
        ...
        >
          ...
          <MainText sx={{ fontSize: { xs: "12px", sm: "16px" } }}>
            ...
            <p>
            After my therapy ended, my interest in mental health continued to grow. I knew that I wanted to offer the same help to others that had been given to me, so I left my career as a teacher to train as a counsellor. It was the best decision I ever made.
            </p>
            <p>
          ...
          <MainText sx={{ fontSize: { xs: "12px", sm: "16px" } }}>
            <p>
            I have been working therapeutically in and around Glasgow since 2021. This includes, most recently, working with two established counselling organisations: Crisis Counselling and The Wynd Centre. Prior to this, starting in 2021, I worked as a distress response worker for a service that supported people in crisis. 
            </p>
            <p>
            Before becoming a counsellor, I spent many years teaching children with additional support needs, including young people who had been through difficult childhood experiences. 
            </p>
            <p>
